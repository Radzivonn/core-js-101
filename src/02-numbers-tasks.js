...
const getAverage = (value1, value2) => parseFloat((BigInt(value1) + BigInt(value2)) / BigInt(2));
 ...
 *   (0,1) (1,2)     => 0
 */
const getAngleBetweenVectors = (x1, y1, x2, y2) => Math.acos(
 ...
 *   1678, 3  => 2000
 */
const roundToPowerOfTen = (num, pow) => (num === 0 ? 0 : Math.round(num / 10 ** pow) * 10 ** pow);
...
const toNumber = (value, def) => {
  ...
  return typeof num === 'number' && num ? num : def;
};
